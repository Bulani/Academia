...
(3,'2018-07-16 22:16:38','2018-07-16 22:16:49.456379'),
(4,'2018-07-16 22:16:51','2018-07-16 22:17:01.026762'),
(5,'2018-07-16 22:21:21',NULL);
...
INSERT INTO `contas_receber`(`idcontas_receber`,`idcontrato`,`valor`,`data_emissao`,`data_vencimento`,`valor_juros`,`pendente`,`idaluno`,`valor_desconto`) VALUES
(4,8,85,'2018-07-18 21:03:01','2018-08-27 00:00:00',0,1,0,0);
/*!40000 ALTER TABLE `contas_receber` ENABLE KEYS */;

-- 
-- Definition of contas_receber_movcaixa
-- 

DROP TABLE IF EXISTS `contas_receber_movcaixa`;
CREATE TABLE IF NOT EXISTS `contas_receber_movcaixa` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_contas_receber` int(10) unsigned NOT NULL DEFAULT '0',
  `id_mov_caixa` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- 
-- Dumping data for table contas_receber_movcaixa
-- 

/*!40000 ALTER TABLE `contas_receber_movcaixa` DISABLE KEYS */;
INSERT INTO `contas_receber_movcaixa`(`id`,`id_contas_receber`,`id_mov_caixa`) VALUES
(1,4,3);
/*!40000 ALTER TABLE `contas_receber_movcaixa` ENABLE KEYS */;
...
(8,'2018-07-18 21:03:01.282505',1,14,0,0,0,27,0);
...
CREATE TABLE IF NOT EXISTS `mov_caixa` (
  ...
  `id_plano_de_conta` int(10) unsigned DEFAULT NULL,
...
INSERT INTO `mov_caixa`(`idmov_caixa`,`data`,`numero_caixa`,`valor`,`tipo_pgto`,`id_plano_de_conta`) VALUES
(3,'2018-07-18 21:30:12',5,50,1,0);
/*!40000 ALTER TABLE `mov_caixa` ENABLE KEYS */;

-- 
-- Definition of plano_de_contas
-- 
...
-- 
-- Dumping data for table plano_de_contas
-- 

/*!40000 ALTER TABLE `plano_de_contas` DISABLE KEYS */;

/*!40000 ALTER TABLE `plano_de_contas` ENABLE KEYS */;
...
-- Dump completed on 2018-07-18 23:10:28
